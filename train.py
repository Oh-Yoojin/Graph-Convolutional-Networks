...
parser.add_argument('--hidden3', type=int, default=300)
...
for epoch in range(args.epochs):
    ...
    train_result.append([train_loss, train_acc, val_loss, val_acc])
    if epoch % 10 == 0:
        test_acc = test()
        test_result.append(test_acc)
np.save('/data1/oyj/data/output/tf_gcn_40_train.npy',train_result)
np.save('/data1/oyj/data/output/tf_gcn_40_test.npy',test_result)
